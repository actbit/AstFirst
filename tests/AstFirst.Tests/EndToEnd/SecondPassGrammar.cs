...
[Precedence(1)]
public sealed partial class SAdd : SNode
{
    [Rule]
    public static void Add(SNode left, [Token(@"\+")] Token op, SNode right) { }
    public override void OnSecondPassEnter(SemanticContext ctx) => SecondPassTrace.Enter(this);
    public override void OnSecondPassExit(SemanticContext ctx) => SecondPassTrace.Exit(this);
}

[Precedence(2)]
public sealed partial class SMul : SNode
{
    [Rule]
...
public sealed partial class SNum : SNode
{
    [Rule]
